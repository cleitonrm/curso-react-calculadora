    ...
    <Jumbotron style= {
      ...
      <Container>
        <Row>
          ...
          <Col xs='9'>
            <Form.Control type="text" name ="txtNumeros" className="text-right" readOnly="readonly" value={txtNumeros}></Form.Control>
          </Col>
        </Row>
        <Row>
          <Col>
          <Button variant='light' onClick={() => adicionarNumero('7')}>7</Button></Col>
        ...
        <Row>
          <Col>
          <Button variant='light' onClick={() => adicionarNumero('4')}>4</Button></Col>
          ...
          <Col>
          <Button variant='light' onClick={() => adicionarNumero('1')}>1</Button></Col>
        ...
        <Row>
          <Col>
          <Button variant='light' onClick={() => adicionarNumero('0')}>0</Button></Col>
